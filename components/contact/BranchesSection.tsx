...
function BranchCard({ branch }: { branch: Branch }) {
  return (
    <div className="flex h-full flex-col items-center text-center">
      <h3 className="n-reg  text-xl font-bold leading-tight text-[#161616] sm:text-[2rem]">
        {branch.name}
      </h3>
      <div className="mt-4 flex w-full min-h-0 flex-1 flex-col justify-between gap-6">
        <p className="n-reg  text-base font-normal leading-[1.35] text-[#161616] sm:text-lg md:text-xl md:leading-[1.2]">
          {branch.address}
        </p>
        <a
          href={branch.mapUrl}
          ...
          className="inline-flex w-full max-w-sm shrink-0 items-center justify-center gap-4 self-center px-6 py-3.5 n-reg  text-base font-bold uppercase tracking-[0.1em] text-white transition-opacity hover:opacity-90 sm:w-auto sm:max-w-none sm:gap-5 sm:px-12 sm:py-[18px] sm:text-xl"
          style={{
            background:
...
export function BranchesSection() {
  return (
    <section className="bg-white pb-16 sm:pb-20 lg:pb-24 pt-4 lg:pt-[40px]" aria-label="Office branches">
      <Container>
        {/* Section heading */}
        <h2 className="text-center qs-reg text-[clamp(2rem,4vw,3.125rem)] font-normal uppercase tracking-[0.05em] text-[#202225] mb-12 lg:mb-16">
          Branches
        </h2>
