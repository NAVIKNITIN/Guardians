...
const baseClassName =
  "group inline-flex items-center justify-center gap-4 px-8 py-3.5 font-nexa text-sm font-bold uppercase tracking-[0.1em] text-white shadow-md transition-all duration-300 ease-out";
