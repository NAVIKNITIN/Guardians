...
export function TestimonialCard({
  ...
  return (
    <article
      ...
      className={cn(
        "group flex h-full min-h-0 w-full flex-col p-6 shadow-sm will-change-transform transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_18px_34px_rgba(22,20,19,0.18)]",
    ...
    >
      <div className="flex items-start gap-4">
        ...
        {/* Profile pic — re-enable when per-person avatarSrc is available
      ...
      <p className="mt-5 flex-1 n-bold text-base leading-relaxed text-brand-text-primary sm:fs-20 sm:lh-24">
        {item.quote}
      </p>
