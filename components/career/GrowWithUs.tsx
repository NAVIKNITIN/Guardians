        ...
        >
            ...
            <Container className="relative z-10">
                <div className="mx-auto flex max-w-4xl flex-col items-center text-center">
                    ...
                    <p className="mt-6 w-full max-w-[min(42rem,90vw)] font-nexa text-base font-normal leading-relaxed text-[#202225]/90 sm:text-lg">
                    ...
                    <a
                        ...
                        className="mt-8 inline-flex items-center gap-2.5 font-nexa text-sm font-bold text-[#202225] transition-opacity hover:opacity-80 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#202225] sm:text-base"
                    >
                    ...
                    <Link
                        href="/contact"
                        className={cn(
                            "mt-10 inline-flex items-center gap-2 rounded-sm px-10 py-3.5 font-nexa text-xs font-bold uppercase tracking-[0.2em] text-white",
