    ...
    >
      ...
      <div className="relative z-10 flex min-h-[min(72vh,560px)] flex-col items-center justify-center px-4 py-14 text-center sm:min-h-[560px] sm:py-20">
        <h1
          ...
          className={cn(
            "max-w-[min(100%,20ch)] break-words qs-reg  uppercase tracking-[0.05em] text-[#202225] sm:max-w-none",
        ...
        <p
          className={cn(
            "mt-4 n-reg   uppercase tracking-[0.1em] text-[#202225]",
        ...
        <p
          className={cn(
            "mt-6 max-w-2xl n-reg   text-black",
