...
export function NewsCard({ article }: { article: NewsArticle }) {
  return (
    <article className="flex flex-col">
      {/* Date */}
      <p className="n-reg  text-sm  leading-snug text-[#161616] sm:text-base">
        {article.date}
      </p>

      {/* Title */}
      <h3 className="mt-2 line-clamp-3 n-reg  text-lg  leading-[1.2] text-[#161616] sm:mt-3 sm:text-xl">
        {article.title}
      </h3>
      ...
      {/* Excerpt */}
      <p className="mt-4 line-clamp-4 n-reg  text-sm  leading-[1.5] text-[#161616] sm:text-base">
        {article.excerpt}
      </p>
      ...
      <Link
        ...
        className={cn(
          ...
          "n-reg  text-sm  uppercase tracking-[0.1em] text-[#202225]",
