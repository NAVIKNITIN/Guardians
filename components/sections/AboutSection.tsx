    ...
    >
      <Container>
        <div className="mx-auto max-w-[980px] text-center n-reg ">
          ...
          <p className="text-xl font-semibold leading-[1.08] text-[#121212] sm:text-2xl md:text-3xl lg:text-4xl">
            We are one of the fastest growing Real Estate consulting company in
            India. It&apos;s growth, today,
          </p>
          <p className="mt-1 text-xl font-medium leading-[1.08] text-[#bdbdbd] sm:text-2xl md:text-3xl lg:text-4xl">
