      ...
      <div className="relative min-w-0 py-8 sm:py-10 lg:py-3 mx-auto w-full max-w-brand px-4 sm:px-6 lg:px-18 xl:px-16">
        ...
        <div className="pointer-events-none absolute inset-0 z-0 overflow-visible" aria-hidden>
          <Image
            ...
            width={344}
            height={193}
            sizes="(max-width: 640px) 90vw, (max-width: 1024px) 40vw, 24rem"
            className="absolute bottom-0 left-60 h-auto w-[min(100%,clamp(6.25rem,min(38vw,28rem),24rem))] max-w-full select-none object-contain object-bottom-left aspect-[344/193]"
          />
        </div>
        ...
        <div className="relative z-10 min-w-0">
          ...
          <div className="mt-8 shrink-0 border-t border-white pt-6 sm:mt-10 sm:pt-2">
            <p className="px-2 text-center n-reg text-xs fw-100 leading-relaxed text-white sm:px-0 sm:text-sm sm:leading-normal">
