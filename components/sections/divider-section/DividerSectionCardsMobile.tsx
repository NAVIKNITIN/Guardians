...
const dividerCardCtaClassName = cn(
  "min-h-[36px] w-fit max-w-full shrink-0 self-start gap-1.5 px-3 py-0",
  "text-[11px] leading-none tracking-normal",
  "sm:gap-2 sm:px-4 sm:py-0 sm:text-[12px] sm:leading-none sm:tracking-normal",
);
