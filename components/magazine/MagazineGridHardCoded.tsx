...
// import { articleImage, normalizeFilteredArticles } from "@/lib/mappers/publicArticles";
...
export function MagazineGridHardCoded() {
  ...
  const issues: PublicationIssue[] = useMemo(
    () => [
      {
        id: "1",
        title: "Guardians Magazine — January 2025",
        imageSrc: "/images/magazine/1.jpg",
      ...
      {
        id: "2",
        title: "Guardians Magazine — February 2024",
        imageSrc: `/images/magazine/2.jpg`,
  ...
  // TODO: Re-enable API listing later.
